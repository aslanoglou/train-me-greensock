...
var tween;
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".home-page-intro__main-title", {
  scrollTrigger: {
...
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.to(".home-page__after-intro-text__text-area", {
  scrollTrigger: {
    trigger: ".home-page__after-intro-text__text-area",
    toggleActions: "restart pause restart pause",
    scrub: true,
    start: "top bottom-=100px",
    end: "top center+=100px" // markers: true,
...
}).from(".purple-area__section--section1", {
  opacity: 0
}).to(".purple-area__section--section1", {
  opacity: 1
});
gsap__WEBPACK_IMPORTED_MODULE_0__.gsap.timeline({
  scrollTrigger: {
...
}).from(".purple-area__section--section2", {
  opacity: 0
}).to(".purple-area__section--section2", {
  opacity: 1
}); // gsap.timeline({
//     scrollTrigger: {
