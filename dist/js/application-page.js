...
var applicationPageSwiper = new (swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0___default())('.application-page.swiper-container', {
  direction: 'vertical',
  effect: 'slide',
  releaseOnEdges: true,
  longSwipes: false,
  ...
  on: {
    ...
    init: function init() {
      animateCSS('.application-intro__image-area', 'fadeInUp').then(function (message) {});
      animateCSS('.application-intro__text-area', 'fadeInUp').then(function (message) {
    ...
    slideChangeTransitionStart: function slideChangeTransitionStart() {
      ...
      if (applicationPageSwiper.activeIndex == 1) {
        ...
        animateCSS('.application-metrics__metrics', 'fadeInUp').then(function (message) {});
        animateCSS('.application-metrics__circle1', 'fadeInUp').then(function (message) {});
        animateCSS('.application-metrics__circle2', 'fadeInUp').then(function (message) {
          applicationPageSwiper.allowSlidePrev = true;
          applicationPageSwiper.allowSlideNext = true;
        });
      }
      ...
      if (applicationPageSwiper.activeIndex == 2) {
        applicationPageSwiper.allowSlidePrev = false;
        applicationPageSwiper.allowSlideNext = false;
        animateCSS('.application-metrics__metrics', 'fadeOutUp').then(function (message) {});
        animateCSS('.application-metrics__circle1', 'fadeOutUp').then(function (message) {});
        animateCSS('.application-metrics__circle2', 'fadeOutUp').then(function (message) {});
        animateCSS('.screen-feedbacks__reps', 'fadeInUp').then();
        animateCSS('.screen-feedbacks__stats', 'fadeInUp').then(function (message) {});
        animateCSS('.workout-friends__text-area', 'fadeOutUp').then(function (message) {
      ...
      if (applicationPageSwiper.activeIndex == 3) {
        ...
        animateCSS('.screen-feedbacks__reps', 'fadeOutUp').then(function (message) {
          document.querySelector('.screen-feedbacks__reps').classList.add('invisible');
        });
        animateCSS('.screen-feedbacks__stats', 'fadeOutUp').then(function (message) {
          document.querySelector('.screen-feedbacks__stats').classList.add('invisible');
        });
        animateCSS('.workout-friends__text-area', 'fadeInUp').then(function (message) {
...
var workoutFriendsSlider = new (swiper_swiper_bundle__WEBPACK_IMPORTED_MODULE_0___default())('.workout-friends__slider.swiper-container', {
  direction: 'vertical',
  effect: 'slide',
  releaseOnEdges: true,
  longSwipes: false,
